...
In order to support loading of multiple wallets in qoinz-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is qoinz.cpp.
...
Changes to qoinz.cpp
----------------------
qoinz.cpp is the entry point into qoinz-qt, and as such, will require some minor modifications to provide hooks for
