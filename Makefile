...
pkgdatadir = $(datadir)/qoinz
pkgincludedir = $(includedir)/qoinz
pkglibdir = $(libdir)/qoinz
pkglibexecdir = $(libexecdir)/qoinz
...
CONFIG_HEADER = $(top_builddir)/src/config/qoinz-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/qoinz-config.h.in \
...
ACLOCAL = ${SHELL} /home/mb/lin/qoinz-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/mb/lin/qoinz-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/mb/lin/qoinz-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/mb/lin/qoinz-core/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = qoinz-cli
BITCOIN_DAEMON_NAME = qoinzd
BITCOIN_GUI_NAME = qoinz-qt
BITCOIN_TX_NAME = qoinz-tx
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/mb/lin/qoinz-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = qoinz
PACKAGE_BUGREPORT = http://qoinz.network/
PACKAGE_NAME = QOINZ Core
PACKAGE_STRING = QOINZ Core 1.3.0
PACKAGE_TARNAME = qoinz
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/mb/lin/qoinz-core
abs_srcdir = /home/mb/lin/qoinz-core
abs_top_builddir = /home/mb/lin/qoinz-core
abs_top_srcdir = /home/mb/lin/qoinz-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/mb/lin/qoinz-core/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/qoinz.icns
OSX_PLIST = $(top_srcdir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/qoinz.ico \
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_qoinz_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_qoinz_coverage.info test_qoinz.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/qoinz.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/qoinz-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/qoinz-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/qoinz-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/qoinz-config.h
$(top_srcdir)/src/config/qoinz-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/qoinz-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/Resources/qoinz.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/qoinz-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/qoinz-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/qoinz-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_qoinz.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_qoinz -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_qoinz_filtered.info: test_qoinz.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_qoinz_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_qoinz_coverage.info: baseline_filtered_combined.info test_qoinz_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_qoinz_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_qoinz_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_qoinz_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_qoinz.coverage/.dirstamp:  test_qoinz_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_qoinz.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local:
	rm -rf test_qoinz.coverage/ total.coverage/ $(OSX_APP)
