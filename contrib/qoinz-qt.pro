...
RESOURCES += src/qt/qoinz.qrc src/qt/qoinz_locale.qrc

TRANSLATIONS += src/qt/locale/qoinz_bg.ts \
                src/qt/locale/qoinz_de.ts \
                src/qt/locale/qoinz_en.ts \
                src/qt/locale/qoinz_es.ts \
                src/qt/locale/qoinz_fi.ts \
                src/qt/locale/qoinz_fr.ts \
                src/qt/locale/qoinz_it.ts \
                src/qt/locale/qoinz_ja.ts \
                src/qt/locale/qoinz_pl.ts \
                src/qt/locale/qoinz_pt.ts \
                src/qt/locale/qoinz_ru.ts \
                src/qt/locale/qoinz_sk.ts \
                src/qt/locale/qoinz_sv.ts \
                src/qt/locale/qoinz_vi.ts \
                src/qt/locale/qoinz_zh_CN.ts \
                src/qt/locale/qoinz_zh_TW.ts
