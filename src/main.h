...
/** The maximum allowed number of signature check operations in a block (QOINZ network rule) */
static const unsigned int QOINZ_MAX_BLOCK_SIGOPS = QOINZ_MAX_BLOCK_SIZE / 50;
/** Maximum number of signature check operations in an IsStandard() P2SH script */
static const unsigned int MAX_P2SH_SIGOPS = 15;
/** The maximum number of sigops we're willing to relay/mine in a single tx */
static const unsigned int MAX_TX_SIGOPS = MAX_BLOCK_SIGOPS / 5;
/** The maximum number of sigops we're willing to relay/mine in a single tx in QOINZ network */
static const unsigned int QOINZ_MAX_TX_SIGOPS = QOINZ_MAX_BLOCK_SIGOPS / 5;
