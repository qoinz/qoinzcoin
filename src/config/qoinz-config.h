/* src/config/qoinz-config.h.  Generated from qoinz-config.h.in by configure.  */
/* src/config/qoinz-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef qoinz_CONFIG_H

#define qoinz_CONFIG_H
...
/* Define to 1 to enable webwallet functions */
/* #undef ENABLE_WEBWALLET */
...
#define PACKAGE_BUGREPORT "http://qoinz.network/"

/* Define to the full name of this package. */
#define PACKAGE_NAME "QOINZ Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "QOINZ Core 1.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "qoinz"
