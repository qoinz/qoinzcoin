 ...
 * qoinz system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& qoinzDevKey() const { return vqoinzDevKey; }
    // const std::vector<unsigned char>& qoinzFundKey() const { return vqoinzFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vqoinzDevKey;
    // std::vector<unsigned char> vqoinzFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
