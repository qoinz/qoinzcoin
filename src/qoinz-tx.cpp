...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("QOINZ Core TX utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  qoinz-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qoinz transaction") + "\n" +
                               "  qoinz-tx [options] -create [commands]   " + _("Create hex-encoded qoinz transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded qoinz transaction
