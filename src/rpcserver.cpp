...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* qoinz features */
        {"qoinz", "masternode", &masternode, true, true, false},
        {"qoinz", "listmasternodes", &listmasternodes, true, true, false},
        {"qoinz", "getmasternodecount", &getmasternodecount, true, true, false},
        {"qoinz", "masternodeconnect", &masternodeconnect, true, true, false},
        {"qoinz", "masternodecurrent", &masternodecurrent, true, true, false},
        {"qoinz", "masternodedebug", &masternodedebug, true, true, false},
        {"qoinz", "startmasternode", &startmasternode, true, true, false},
        {"qoinz", "createmasternodekey", &createmasternodekey, true, true, false},
        {"qoinz", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"qoinz", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"qoinz", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"qoinz", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"qoinz", "getmasternodescores", &getmasternodescores, true, true, false},
        {"qoinz", "mnsync", &mnsync, true, true, false},
        {"qoinz", "spork", &spork, true, true, false},
        {"qoinz", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"qoinz", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use qoinzd, or the -server option to qoinz-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> qoinz-cli " + methodname + " " + args + "\n";
}
