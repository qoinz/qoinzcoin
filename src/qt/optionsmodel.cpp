...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::QOINZ);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePhcAmount"))
        SoftSetArg("-anonymizeqoinzamount", settings.value("nAnonymizePhcAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in qoinz.cpp during shotdown to also remove the window positions
