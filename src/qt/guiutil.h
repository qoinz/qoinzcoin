...
/** Utility functions used by the qoinz Qt UI.
 */
namespace GUIUtil
{
...
// Render qoinz addresses in monospace font
...
// Parse "qoinz:" URI into recipient object, return true on successful parsing
