...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Qoinz Core Wallet ");
    ...
    QString copyrightTextqoinz = QChar(0xA9) + QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The QOINZ Core developers"));
    ...
    pixPaint.drawText(paddingLeft+190, paddingTop,titleText);
    ...
    pixPaint.drawText(paddingLeft+144, paddingTop + titleCopyrightVSpace + 42, copyrightTextqoinz);
