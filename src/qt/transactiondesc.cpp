...
QString TransactionDesc::toHTML(CWallet* wallet, CWalletTx& wtx, TransactionRecord* rec, int unit)
{
    ...
    //QString txIDWithHref = "<a href=\"http://explorer.qoinz.network/transactions/?transaction_hash=" + rec->getTxID() + "&view=public" + "\">" + rec->getTxID() + "</a>";
	QString txIDWithHref = "<a href=\"http://explorer.qoinz.network/tx/" + rec->getTxID() + "\">" + rec->getTxID() + "</a>";
    strHTML += "<b>" + tr("Transaction ID") + ":</b> " + txIDWithHref + "<br>";
    strHTML += "<b>" + tr("Output index") + ":</b> " + QString::number(rec->getOutputIndex()) + "<br>";

    // Message from normal qoinz:URI (qoinz:XyZ...?message=example)
