...
#   c) node1 mines 32 blocks, so now node 0 has 60001 qoinz, node 1 has 4250 qoinz, node2 has none.
#   d) node0 sends 601 qoinz to node2, in two transactions (301 qoinz, then 300 qoinz).
